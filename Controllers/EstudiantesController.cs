...
namespace StudentService.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(StudentServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Edad,Matricula")] Estudiantes estudiantes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Edad,Matricula")] Estudiantes estudiantes)
        {
